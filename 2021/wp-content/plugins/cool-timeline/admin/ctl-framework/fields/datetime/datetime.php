...
//class CSFramework_Option_date_picker extends CSFramework_Options {
	...
	public function render() {
		...
		wp_register_script( 'ctl-flatpickr-script-btn',COOL_TIMELINE_PLUGIN_URL.'/assets/js/ctl-flatpicker-btn.js', array('jquery'), COOL_TIMELINE_CURRENT_VERSION, true);
		wp_register_style( 'ctl-flatpickr-styles-btn', COOL_TIMELINE_PLUGIN_URL.'/assets/css/ctl-flatpicker-btn.css' );
