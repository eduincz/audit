	...
	$args = array( 'post_type' => 'cpt_udalost',
				...
				foreach($posts as $post){
					...
					foreach(get_post_meta($post->ID, 'tagy', true) as $tag){
						...
						if($tag === 'přijímací zkoušky' || $tag === 'Přijímací zkoušky'){
							$tag = 'prijimaci';
						}
					...
					<div class="container">
						...
						<div class="col xl2 l2 m3 s12">
							<a href="#" class="event event-new filter-inkluze <?php if(in_array('inkluze', $tagsArray) === true){
								...
								<div class="event-img-block event-img-block-new">
									<img src="https://audit.eduin.cz/2021/wp-content/uploads/2021/12/ikona_inkluze.svg" alt="" />
							...
							<a href="#" class="event event-new filter-technologie <?php if(in_array('technologie', $tagsArray) === true){
								...
								<div class="event-img-block event-img-block-new">
									<img src="https://audit.eduin.cz/2021/wp-content/uploads/2021/12/ikona_technologie.svg" alt="" />
						...
						<div class="col xl2 l3 m3 s12">
							<a href="#" class="event event-new filter-finance <?php if(in_array('finance', $tagsArray) === true){
								...
								<div class="event-img-block event-img-block-new">
									<img src="https://audit.eduin.cz/2021/wp-content/uploads/2021/12/ikona_financovani.svg" alt="" />
						...
						<div class="col xl2 l2 m3 s12">
							<a href="#" class="event event-new filter-maturity <?php if(in_array('maturity', $tagsArray) === true){
								...
								<div class="event-img-block event-img-block-new">
									<img src="https://audit.eduin.cz/2021/wp-content/uploads/2021/12/ikona_maturity.svg" alt="" />
						...
						<div class="col xl3 l4 m4 s12">
							<a href="#" class="event event-new filter-neformalni <?php if(in_array('neformalni', $tagsArray) === true){
								...
								<div class="event-img-block event-img-block-new">
									<img src="https://audit.eduin.cz/2021/wp-content/uploads/2021/12/ikona_neformalni_vzdelavani.svg" alt="" />
						...
						<div class="col xl4 l4 m3 s12">
							<a href="#" class="event event-new filter-nerovnosti <?php if(in_array('nerovnosti', $tagsArray) === true){
								...
								<div class="event-img-block event-img-block-new">
									<img src="https://audit.eduin.cz/2021/wp-content/uploads/2021/12/ikona_nerovnosti.svg" alt="" />
									<span class="event-img-block-new-text">nerovnosti ve vzdělávání</span>
								</div>
							</a>
						</div>
								
						<div class="col xl2 m3 s12">
							<a href="#" class="event event-new  filter-covid <?php if(in_array('covid', $tagsArray) === true){
									echo 'event-new-selected';
								}?>" data-tag="covid">
								<div class="event-img-block event-img-block-new">
									<img src="https://audit.eduin.cz/2021/wp-content/uploads/2021/12/ikona_covid.svg" alt="" />
						...
						<div class="col xl2 m3 s12">
							<a href="#" class="event event-new filter-ucitele <?php if(in_array('ucitele', $tagsArray) === true){
								...
								<div class="event-img-block event-img-block-new">
									<img src="https://audit.eduin.cz/2021/wp-content/uploads/2021/12/ikona_ucitele.svg" alt="" />
						...
						<div class="col xl2 m3 s12">
							<a href="#" class="event event-new filter-materske <?php if(in_array('materske', $tagsArray) === true){
								...
								<div class="event-img-block event-img-block-new">
									<img src="https://audit.eduin.cz/2021/wp-content/uploads/2021/12/ikona_MS.svg" alt="" />
						...
						<div class="col xl2 m3 s12">
							<a href="#" class="event event-new filter-zakladni <?php if(in_array('zakladni', $tagsArray) === true){
								...
								<div class="event-img-block event-img-block-new">
									<img src="https://audit.eduin.cz/2021/wp-content/uploads/2021/12/ikona_ZS.svg" alt="" />
						...
						<div class="col xl2 m3 s12">
							<a href="#" class="event event-new filter-stredni <?php if(in_array('stredni', $tagsArray) === true){
								...
								<div class="event-img-block event-img-block-new">
									<img src="https://audit.eduin.cz/2021/wp-content/uploads/2021/12/ikona_SS.svg" alt="" />
						...
						<div class="col xl2 m3 s12">
							<a href="#" class="event event-new filter-vysoke <?php if(in_array('vysoke', $tagsArray) === true){
								...
								<div class="event-img-block event-img-block-new">
									<img src="https://audit.eduin.cz/2021/wp-content/uploads/2021/12/ikona_VS.svg" alt="" />
						...
						<div class="col xl2 l3 m3 s12">
							<a href="#" class="event event-new filter-legislativa <?php if(in_array('legislativa', $tagsArray) === true){
								...
								<div class="event-img-block event-img-block-new">
									<img src="https://audit.eduin.cz/2021/wp-content/uploads/2021/12/ikona_zakony.svg" alt="" />
									<span class="event-img-block-new-text">legislativa</span>
								</div>
							</a>
						</div>
						<div class="col xl4 m3 s12">
							<a href="#" class="event event-new filter-prijimaci <?php if(in_array('prijimaci', $tagsArray) === true){
									echo 'event-new-selected';
								}?>" data-tag="prijimaci">
								<div class="event-img-block event-img-block-new">
									<img src="https://audit.eduin.cz/2021/wp-content/uploads/2021/12/ikona_prijimci_zkousky.svg" alt="" />
									<span class="event-img-block-new-text">přijímací zkoušky</span>
								</div>
							</a>
						</div>
						<div class="col xl2 m3 s12">
							<a href="#" class="event event-new filter-rvp <?php if(in_array('rvp', $tagsArray) === true){
									echo 'event-new-selected';
								}?>" data-tag="rvp">
								<div class="event-img-block event-img-block-new">
									<img src="https://audit.eduin.cz/2021/wp-content/uploads/2021/12/ikona_RVP_SVP.svg" alt="" />
							...
							<div class="row">
								...
								<a href="https://audit.eduin.cz/2021/udalosti-nove/" class="reset-button">
									RESETOVAT
								</a>
								<br />
							</div>
						...
						<div class="row">
							<div class="events-list">
								...
								foreach($filteredParsedPosts as $post){
									/*if($post['id'] === '2024' && $hiddenAlready === false){
										$hiddenAlready = true;
										continue;
									}*/
									if($post['id'] !== 2024 && $post['id'] !== 2568 && $post['id'] !== 2021){
										$hiddenAlready = true;
										$eventHidden = '';
										echo "<div class=\"row\">
										<a href=\"https://audit.eduin.cz/2021/udalost-detail/?udalost_id=".$post['id']."\" class=\"event-list-item ".$eventHidden." event-".$cnt." ".$post['tags_string']." ".$post['mesic']."\">
