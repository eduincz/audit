...
$link = "https://audit.eduin.cz/2021/analyza-obecna-detail/?analyza_id=". $defaultAnalysisId;
...
<div class="analysis-text-detail-links">
	<div class="container">
		<br />
		<div class="row">
			<a href="https://audit.eduin.cz/2021/seznam-vsech-analyz/" class="btn btn-primary more-button homepage-blue analysis-list">Seznam analýz</a>
		</div>
		<br />
		<div class="row">
