...
<?php if ($this->_tpl_vars['instanceForm'] || $this->_tpl_vars['instanceFormError']): ?> <div class="crm-accordion-wrapper crm-report_setting-accordion crm-accordion_title-accordion <?php if ($this->_tpl_vars['rows']): ?>crm-accordion-closed<?php else: ?>crm-accordion-open<?php endif; ?>">
