...
smarty_core_load_plugins(array('plugins' => array(array('function', 'crmURL', 'CRM/Contact/Form/Edit/Individual.tpl', 29, false),array('function', 'help', 'CRM/Contact/Form/Edit/Individual.tpl', 107, false),array('block', 'ts', 'CRM/Contact/Form/Edit/Individual.tpl', 54, false),array('modifier', 'crmReplace', 'CRM/Contact/Form/Edit/Individual.tpl', 108, false),)), $this); ?>
<script type="text/javascript">
var cid=parseFloat("<?php echo $this->_tpl_vars['contactId']; ?>
");//parseInt is octal by default
var contactIndividual = "<?php echo CRM_Utils_System::crmURL(array('p' => 'civicrm/ajax/rest','q' => 'fnName=civicrm/contact/search&json=1&contact_type=Individual&return[display_name]&return[sort_name]=1&return[email]=1&rowCount=50','h' => 0), $this);?>
";
