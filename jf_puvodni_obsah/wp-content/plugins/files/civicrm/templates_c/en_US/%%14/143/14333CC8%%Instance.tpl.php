...
<br />
 ...
 <?php echo smarty_function_help(array('id' => "id-report_perms",'file' => "CRM/Report/Form/Settings.hlp"), $this);?>
        ...
        <tr class="crm-report-instanceForm-form-block-role">
            ...
            <td><?php echo ((is_array($_tmp=$this->_tpl_vars['form']['grouprole']['html'])) ? $this->_run_mod_handler('crmReplace', true, $_tmp, 'class', 'huge') : smarty_modifier_crmReplace($_tmp, 'class', 'huge')); ?>
</td>
        </tr>
    <?php endif; ?>
